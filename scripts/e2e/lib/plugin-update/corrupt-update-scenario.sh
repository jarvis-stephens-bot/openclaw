...
# Preserve unpublished core dependencies when the recovery registry handles the plugin.
export OPENCLAW_NPM_REGISTRY_UPSTREAM="${npm_config_registry:-${NPM_CONFIG_REGISTRY:-https://registry.npmjs.org/}}"
